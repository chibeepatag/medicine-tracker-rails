...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { antibiotic: @medicine.antibiotic, class: @medicine.class, dose: @medicine.dose, end_date: @medicine.end_date, frequency: @medicine.frequency, route: @medicine.route, start_date: @medicine.start_date } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { antibiotic: @medicine.antibiotic, class: @medicine.class, dose: @medicine.dose, end_date: @medicine.end_date, frequency: @medicine.frequency, route: @medicine.route, start_date: @medicine.start_date } }
